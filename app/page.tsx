...
const FlippableCard = ({
  ...
  <div className="flip-card h-[280px] sm:h-[300px] md:h-[280px] group">
    <div className="flip-card-inner">
      {/* Front of Card */}
      <div className="flip-card-front bg-white/5 border border-white/10 p-4 sm:p-6 flex flex-col items-center justify-center text-center backdrop-blur-sm">
        {icon}
        ...
        <div className="absolute bottom-3 sm:bottom-4 text-xs text-gray-400 group-hover:opacity-0 transition-opacity hidden sm:block">
          Hover to see more
        </div>
        <div className="absolute bottom-3 text-xs text-gray-400 sm:hidden">
          Tap to see more
        </div>
      </div>
      {/* Back of Card */}
      <div className="flip-card-back bg-gray-900/80 border border-red-500/50 p-4 sm:p-6 flex flex-col justify-between text-left backdrop-blur-md">
        <div>
        ...
        <Button
          ...
          size="sm"
          asChild
          className="mt-3 sm:mt-4 w-full border-red-500 text-white hover:bg-red-500 hover:text-white bg-transparent min-h-[44px] text-xs sm:text-sm"
        >
...
const Differentiator = ({
  ...
  <div className="flex items-center space-x-2 sm:space-x-3 bg-white/5 p-3 sm:p-4 rounded-lg min-h-[48px]">
    ...
    <RedWaveLayout currentPage="home">
      ...
      <section className="relative z-10 w-full min-h-[calc(80vh)] flex flex-col items-center justify-center px-6 py-20 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed mb-10">
            Think RAM is where tech professionals, enterprise leaders, and
            partners turn strategy into outcomes. Human-led, AI-powered, and
            purpose-built for transformation that sticks.
          </p>
          <Button
            variant="outline"
            size="lg"
      ...
      <section className="py-16 md:py-24 bg-black/20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-300 max-w-3xl mx-auto mb-12">
            Whether you’re a professional ready to elevate your career, an
            enterprise looking for program rescue or a partner trying to enter
            the public sector—we’ve got a pathway for you.
          </p>
      ...
      <section id="framework" className="py-16 md:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-300 max-w-3xl mx-auto mb-12">
            Our RAM Framework drives every transformation forward with clarity
            and confidence.
          </p>
          <div className="mb-12">
            <Image
          ...
          <div className="grid md:grid-cols-3 gap-8 text-left">
            <div className="bg-white/5 p-6 rounded-xl">
              ...
              <p className="text-gray-300">
                Define vision. Align roadmaps. Build readiness.
              </p>
            </div>
            <div className="bg-white/5 p-6 rounded-xl">
              ...
              <p className="text-gray-300">
                Execute fast. Deliver outcomes. Reduce risk.
              </p>
            </div>
            <div className="bg-white/5 p-6 rounded-xl">
              <h3 className="text-2xl font-bold text-red-500 mb-2">
              ...
              <p className="text-gray-300">
                Sustain success. Embed governance. Scale capability.
              </p>
            </div>
          </div>
          <div className="mt-12">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">
                While others sell frameworks, reports, or theory, Think RAM
                exists to solve the execution crisis in tech and digital
                transformation. With 20+ years of lived experience and over $2B
                in transformation programs delivered, we’ve seen it all—and
                we’ve built what’s missing.
              </p>
              <div className="grid md:grid-cols-2 gap-4 mt-8">
                <Differentiator
                  icon={<Target className="w-5 h-5 text-red-400" />}
                  text="Execution-first mindset"
                />
                <Differentiator
                  icon={<Package className="w-5 h-5 text-red-400" />}
                  text="End-to-end value"
                />
                <Differentiator
                  icon={<Globe className="w-5 h-5 text-red-400" />}
                  text="Built for Australia"
                />
                <Differentiator
                  icon={<FileText className="w-5 h-5 text-red-400" />}
                  text="Frameworks you can use"
                />
                <Differentiator
                  icon={<Network className="w-5 h-5 text-red-400" />}
                  text="Embedded trust network"
                />
                <Differentiator
                  icon={<ShieldCheck className="w-5 h-5 text-red-400" />}
                  text="Ethically governed"
                />
              </div>
            </div>
            <div className="space-y-8">
              <div className="bg-red-900/20 border border-red-500/30 rounded-xl p-8 text-center">
                <p className="text-5xl md:text-6xl font-extrabold text-red-500">
                  75%
                </p>
