...
const ServicePillarCard = ({ title, description }: { title: string; description: string }) => (
...
const RamPhase = ({
  ...
  <div className="grid lg:grid-cols-5 gap-8 items-start">
    <div className="lg:col-span-1 text-center lg:text-left">
      <h3 className="text-5xl font-extrabold text-red-500 mb-2">{phase}</h3>
    ...
    <div className="lg:col-span-4 grid md:grid-cols-2 gap-6">
      <div className="bg-white/5 p-4 rounded-lg">
        <h5 className="font-bold text-white mb-3">Services Mapped</h5>
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed mb-12 md:mb-16">
            Full-spectrum support for digital and technology transformations, driven by our Realise-Accelerate-Modernise
            (RAM) framework.
          </p>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Tabs defaultValue="strategic" className="w-full">
            <TabsList className="grid w-full grid-cols-3 mb-8 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-1">
              <TabsTrigger value="strategic" className="tab-trigger">
                A. Strategic Framing & Readiness
              </TabsTrigger>
              <TabsTrigger value="delivery" className="tab-trigger">
                B. Delivery Enablement & Execution
              </TabsTrigger>
              <TabsTrigger value="governance" className="tab-trigger">
                C. Governance, Adoption & Sustainability
              </TabsTrigger>
            </TabsList>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto">
              Our full-spectrum model drives successful transformations through structured execution, measurable
              outcomes, and high-trust governance.
            </p>
          </div>
